...
class ManagerProfesor {
    ...
    function setTipo($id, $tipo){
        $r = $this->db->updateParameters(self::TABLA, array('tipo'=>$tipo), array('idProfesor'=>$id));
        return $r;
    }
    
    function setProfesor($profesor, $id){
        $r = $this->db->updateParameters(self::TABLA, $profesor, $id);
        return $r;
    }
